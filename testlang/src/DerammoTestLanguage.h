...
class DerammoTestThreadContext;

class DerammoTestLanguage : public godot::ScriptLanguageExtension {
...
public:
    ...
    godot::Ref<godot::Script> module_create_script() const;
    ...
    godot::Ref<godot::Script> _make_template(const String& _template, const String& class_name, const String& base_class_name) const
    override;
    godot::Ref<godot::ScriptLanguageThreadContextExtension> _create_thread_context() const override;

    static DerammoTestThreadContext& current_thread();
